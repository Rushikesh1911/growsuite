...
import { Lock, Mail, ArrowRight, Loader2, Command } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#000000] flex flex-col items-center justify-center p-4 selection:bg-[#EDEDED] selection:text-[#000000]">
      ...
      <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="flex flex-col items-center text-center mb-8 gap-2">
          <h1 className="text-2xl font-bold text-[#EDEDED] tracking-tight">Welcome back</h1>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-[12px] font-medium text-[#666666] hover:text-[#EDEDED] transition-colors">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <button
                ...
                className="w-full bg-[#111111] hover:bg-[#1A1A1A] text-[#EDEDED] border border-[#333333] rounded-[6px] py-2.5 px-4 text-[13px] font-bold flex items-center justify-center gap-2.5 transition-colors"
              >
