        ...
        <div className="grid grid-cols-1 md:grid-cols-[4fr_6fr] gap-16 md:gap-20 items-center">
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-4">
              <span className="text-[11px] font-semibold text-[#3A3A3A] uppercase tracking-[0.09em]">Activity</span>
              <h2 className="text-[32px] sm:text-[40px] md:text-[46px] font-medium tracking-tight text-[var(--gs-fg)] leading-[1.05]">
                From first conversation.
                <br />
                <span className="text-[#77777A]">To paid invoice.</span>
              </h2>
              <p className="text-[16px] text-[#707070] leading-[1.6] max-w-sm font-normal tracking-tight">
            ...
            <div className="flex flex-col gap-5">
              {[
                ...
                <div key={point} className="flex items-start gap-3.5">
                  ...
                  <span className="text-[14.5px] font-medium text-[#808080] tracking-tight leading-[1.5]">{point}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#1C1E22]">
              <span className="text-[14px] font-semibold text-[#E0E0E0] tracking-tight">Activity feed</span>
              <div className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse opacity-80" aria-hidden="true" />
                <span className="text-[10px] text-[#666] font-semibold uppercase tracking-widest opacity-30">Live</span>
              </div>
            </div>
            ...
            <div className="flex flex-col divide-y divide-[#16181C]">
              {EVENTS.map((event, i) => (
                ...
                >
                  <span className="text-[11px] text-[#404040] tabular-nums pt-1 shrink-0 w-10 font-mono tracking-tight">
                    {event.time}
                  </span>
                  <div 
                  ...
                  <div className="flex-1 min-w-0">
                    <p 
                      className="text-[13.5px] font-semibold leading-snug tracking-tight transition-colors duration-500"
