...
const getOAuth2Client = () => {
    return new googleapis_1.google.auth.OAuth2(process.env.GOOGLE_CLIENT_ID || 'mock_client_id', process.env.GOOGLE_CLIENT_SECRET || 'mock_client_secret', process.env.GOOGLE_REDIRECT_URI || 'http://localhost:5000/api/google/callback');
};
// Initiate Google OAuth login
router.get('/login', auth_1.requireAuth, (req, res) => {
    try {
