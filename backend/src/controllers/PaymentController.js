...
class PaymentController {
    ...
    static async createPayment(req, res) {
        try {
            ...
            socket_1.SocketService.emitToWorkspace(workspaceId, 'payment_created', result.payment);
            socket_1.SocketService.emitToWorkspace(workspaceId, 'invoice_updated', result.invoice);
        }
        catch (error) {
