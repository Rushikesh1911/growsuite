...
export class InvoiceController {
  ...
  static async getPublicInvoice(req: Request, res: Response) {
    try {
      const { id } = req.params;
  ...
  static async generatePublicPdf(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const invoice = await prisma.invoice.findUnique({
        where: { id: Number(id) },
  ...
  static async createInvoice(req: AuthRequest, res: Response) {
    try {
      ...
      SocketService.emitToWorkspace(workspaceId, 'invoice_created', invoice);
    } catch (error) {
  ...
  static async updateInvoice(req: AuthRequest, res: Response) {
    try {
      ...
      SocketService.emitToWorkspace(workspaceId, 'invoice_updated', updatedInvoice);
    } catch (error) {
